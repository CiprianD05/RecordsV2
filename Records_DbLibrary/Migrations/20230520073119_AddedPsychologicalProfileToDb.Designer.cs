...
namespace RecordsDbLibrary.Migrations
{
    ...
    [Migration("20230520073119_AddedPsychologicalProfileToDb")]
    partial class AddedPsychologicalProfileToDb
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RecordsModels.PsychologicalProfile", b =>
                {
                    ...
                    b.Property<string>("ImpulsiveBehaviorAndAngertManagementProblems")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
